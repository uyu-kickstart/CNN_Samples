...
(2) たたみ込み	ReLU	filter:4	karnel:3*3	zeroPad:なし	output:8*(W-10)*(W-10)
(3) Maxプーリング						karnel:3*3	zeroPad:なし	output:8*(W-12)*(W-12)
...
mlp:add(nn.Reshape(2 * 4 * (width-12) * (width-12)))
mlp:add(nn.Linear(2 * 4 * (width-12) * (width-12), 2*classes))
mlp:add(nn.ReLU())
